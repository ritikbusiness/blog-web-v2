  ...
  return compact ? (
    <div className="flex items-center gap-4">
      <Avatar className="h-10 w-10">
        <AvatarImage src="/author-ritik-shah.png" alt="Ritik Shah - Author" />
        <AvatarFallback>RS</AvatarFallback>
      </Avatar>
      <div>
        <p className="font-medium">Ritik Shah</p>
        <p className="text-xs text-muted-foreground">Computer Engineer | DevOps & Cloud Enthusiast</p>
      </div>
    </div>
  ) : (
    <div className="flex flex-col md:flex-row gap-6 items-start p-6 bg-accent/50 rounded-lg">
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Computer Engineer | DevOps & Cloud Enthusiast | Motivational Writer & Poet</p>
        </div>
        <p>
