...
const About = () => {
  useEffect(() => {
    ...
    console.log("About page mounted successfully");
  }, []);
  ...
  const personSchemaData = {
    name: "Ritik Shah",
    url: "/about",
    image: "/lovable-uploads/8035579f-2b49-4a77-ae2c-fee78ff4e127.png",
  ...
  return (
    <div className="min-h-screen">
      <noscript>
        <p>Welcome to Ritik Shah's personal blog - Computer Engineer & Writer. This is the About section.</p>
      </noscript>
        ...
        <div className="container max-w-3xl">
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-start mb-12">
            <div className="w-full md:w-1/3">
              <img 
                src="/lovable-uploads/8035579f-2b49-4a77-ae2c-fee78ff4e127.png" 
